...
const locationData: LocationNeed[] = [
  ...
  {
    location: 'Brooklyn Goodwill',
    address: '234 Brooklyn Ave',
    city: 'Brooklyn',
    state: 'NY',
    distance: 3.5,
  ...
  {
    location: 'Queens Goodwill',
    address: '567 Queens Blvd',
    city: 'Queens',
    state: 'NY',
    distance: 4.7,
  ...
  {
    location: 'Bronx Goodwill',
    address: '890 Bronx Pkwy',
    city: 'Bronx',
    state: 'NY',
    distance: 5.9,
    urgentNeeds: ['Winter clothing', 'Kids items', 'School supplies'],
    regularNeeds: ['Books', 'Clothing', 'Home decor'],
    notNeeded: ['CRT TVs', 'Old computers', 'Broken furniture'],
  },
];
